...
<div class="mt-30">
<h2>제목 : <%=CmmUtil.nvl(rDTO.getTitle())%></h2>
</div>
<div class="mt-30">
<h3>작성일 : <%=CmmUtil.nvl(rDTO.getReg_dt())%></h3>
</div>
<div class="mt-30">
<textarea class="single-textarea" placeholder="Message" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Message'" disabled>
