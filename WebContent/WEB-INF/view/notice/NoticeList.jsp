...
%>
						<div class="table-row">
							<div class="serial"><%out.println(CmmUtil.nvl(rList.get(i).getNotice_seq()));%></div>
							<a class="country" href="javascript:doDetail('<%=CmmUtil.nvl(rList.get(i).getNotice_seq())%>');">
														<%=CmmUtil.nvl(rList.get(i).getTitle()) %></a>	
							<div class="visit"><%out.println(CmmUtil.nvl(rList.get(i).getUser_name()));%></div>
							<div class="percentage"><%out.println(CmmUtil.nvl(rList.get(i).getReg_dt()));%></div>							
						</div>
						<%
						}
						%>						
