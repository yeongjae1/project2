...
public class UserInfoService implements IUserInfoService {
	...
	@Override
	public void chgPW(UserInfoDTO pDTO) throws Exception {
				
		 userInfoMapper.chgPW(pDTO);
	}
	...
	@Override
	public void deleteId(UserInfoDTO pDTO) throws Exception {
		
		userInfoMapper.deleteId(pDTO);
	}

	@Override
	public List<UserInfoDTO> manage() throws Exception {
		
		return userInfoMapper.manage();
	}
